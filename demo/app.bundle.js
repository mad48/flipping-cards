...
var _flippingReact = __webpack_require__(27);

var _flippingReact2 = _interopRequireDefault(_flippingReact);
...
var _flipping = __webpack_require__(31);
...
var ReactFlipping = function (_React$Component) {
     _inherits(ReactFlipping, _React$Component);

     function ReactFlipping(props) {
          _classCallCheck(this, ReactFlipping);

          var _this = _possibleConstructorReturn(this, (ReactFlipping.__proto__ || Object.getPrototypeOf(ReactFlipping)).call(this, props));

          _this.state = {};
          return _this;
     }

     _createClass(ReactFlipping, [{
          key: 'componentDidMount',
          value: function componentDidMount() {
               _flipping2.default.init(this.props.id, this.props.options);
          }
     }, {
          key: 'render',
          value: function render() {
               return _react2.default.createElement(
                    'div',
                    { id: this.props.id, className: 'flipping' },
...
var flipping = {
    ...
    //----------------------------------------------------------------------------------------------
    sequential: function sequential(dir) {
        var self = this;
        var i = 0;
    ...
    //----------------------------------------------------------------------------------------------
    autoflip: function autoflip(state) {
        var self = this;

        if (state) {
            // && self.options["autoflip-mode"]
    ...
    getBrowser: function getBrowser() {
        if (navigator.userAgent.search(/Safari/) > -1) return "safari";else return "";
    },
    // ---------------------------------------------------------------------------------------------
